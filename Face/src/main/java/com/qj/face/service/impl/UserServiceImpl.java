...
import com.qj.face.dao.UserDao;
...
import com.qj.face.utils.TokenUtils;
...
public class UserServiceImpl extends BaseApiService implements UserService {
	...
	@Override
	public List<UserEntity> queryUser(int indexPage,int pageSize,String userName,String phone,String date_s,String date_e) {
		int start = indexPage == 1 ? 0 :  (indexPage-1)* pageSize; 
		return memberDao.queryUser(start,pageSize,userName,phone,date_s,date_e);
	}
